        ...
        <div className="animate-fade-in-up w-full space-y-10">
            ...
            <div>
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-white rounded-2xl shadow-xl shadow-emerald-500/10 border border-emerald-100 flex items-center justify-center text-2xl animate-bounce-slow">
                            📊
                        </div>
                        <div>
                            <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight">Thống kê doanh thu</h3>
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-0.5">Hiệu suất hệ thống thời gian thực</p>
                        </div>
                    </div>
                    <button
            ...
            <div>
                <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-white rounded-2xl shadow-xl shadow-blue-500/10 border border-blue-100 flex items-center justify-center text-2xl">
                        ⚡
                    </div>
                    <div>
                        <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight">Thao tác nhanh</h3>
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-0.5">Trung tâm điều hành & Cấu hình</p>
                    </div>
                </div>
            ...
            <div>
                <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-white rounded-2xl shadow-xl shadow-purple-500/10 border border-purple-100 flex items-center justify-center text-2xl">
                        📈
                    </div>
                    <div>
                        <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight">Phân tích tăng trưởng</h3>
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-0.5">Dữ liệu doanh thu & Phân bổ đơn hàng</p>
                    </div>
                </div>
            ...
            <div>
                <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-white rounded-2xl shadow-xl shadow-orange-500/10 border border-orange-100 flex items-center justify-center text-2xl">
                        📦
                    </div>
                    <div>
                        <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight">Quản lý kho hàng</h3>
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-0.5">Sản phẩm bán chạy & Cảnh báo tồn kho</p>
                    </div>
                </div>
            ...
            <div>
                <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-white rounded-2xl shadow-xl shadow-amber-500/10 border border-amber-100 flex items-center justify-center text-2xl">
                        💳
                    </div>
                    <div>
                        <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight">Dòng tiền hệ thống</h3>
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-0.5">Lịch sử giao dịch & Thanh toán mới nhất</p>
                    </div>
                </div>
                <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/40 border-2 border-amber-200 overflow-hidden">
                    <div className="p-8 border-b border-slate-50 flex justify-between items-center bg-gradient-to-r from-slate-50/50 to-white">
                        <div>
                            <h4 className="text-sm font-black text-slate-800 uppercase tracking-widest">Danh sách giao dịch</h4>
                            <p className="text-[9px] text-slate-400 font-bold uppercase tracking-widest mt-1">Cập nhật thời gian thực</p>
                        </div>
