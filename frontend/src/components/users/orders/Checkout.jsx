...
const Checkout = () => {
    ...
    const VIETNAM_PROVINCES = [
        "Hà Nội", "Hồ Chí Minh", "An Giang", "Bà Rịa - Vũng Tàu", "Bắc Giang", "Bắc Kạn", "Bạc Liêu",
        ...
        "Hà Giang", "Hà Nam", "Hà Tĩnh", "Hải Dương", "Hải Phòng", "Hòa Bình",
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                setFormData(prev => ({ ...prev, ten_nguoi_nhan: u.hovaten || '', sdt_nguoi_nhan: u.sdt || '', dia_chi_giao: u.diachi || '' }));
                try {
